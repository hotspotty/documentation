...
You need to understand the Hotspotty fundamentals to read the map. We also recommend to linking to Discord and verify your wallet to get the most out of the Hotspotty analytics and location planning tools.
...
See more on [Add your HNT wallet](./add-your-HNT-wallet.)
